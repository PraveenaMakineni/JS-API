...
var form_validations = () => {
    ...
    var msgDOM = document.getElementById('address')
    ...
    var msgErr = document.getElementById('address_err')
    ...
    if (address.value == undefined || address.value == "") {
        msgErr.innerHTML = `${wrong} Enter Your Address`
        msgErr.style.color = "red"
        msgDOM.style.border = "1px solid red"
        status = false 
    }
    else if (!address.value.match(/^[a-z]+$/) ){
        msgErr.innerHTML = `${wrong} message must be 1-uppercase`
        msgErr.style.color = "red"
        msgDOM.style.border = "1px solid red"
        status = false
    }
        ...
        msgErr.innerText = ""
        msgDOM.style.border = "1px solid #e5e5e5"
    }
